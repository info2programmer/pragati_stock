        ...
        <th>
            <table>
                <tr>
                    ...
                    <td width="20%" align="center" valign="top"><span style="font-family: Eczar; font-size: 32px; line-height: 36px">ॐ</span><br><span style="font-family: 'Gill Sans MT Condensed'; font-size: 16px; text-decoration: underline">CASH MEMO</span></td>

...
?>
<a href="index.html" class="logo"><span style="font-weight: 800;font-size: 28px;font-family: cursive;">PRAGATI</span><!--<img class="img-fluid able-logo" src="<?php echo base_url();?>material/assets/images/logo.png" alt="Theme-logo">--></a>
